...
pygame.display.set_caption("First Game!") # título de la ventana
...
START_FONT = pygame.font.Font('Assets/PressStart2P-vaV7.ttf', 30)
TITLE_FONT = pygame.font.Font('Assets/PixemonTrialRegular-p7nLK.ttf', 100)
HEALTH_FONT = pygame.font.SysFont('andalemono', 40)
...
def start():
    ...
    while start:
        ...
        start_text = START_FONT.render("PRESS 'ENTER' TO START", 1, YELLOW)
        title_text = TITLE_FONT.render("GAME NAME", 1, YELLOW)
        WIN.blit(START_BG, (0, 0))
